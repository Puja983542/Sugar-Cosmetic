...
document.getElementById("cartpagemaindiv1").innerHTML="";
    ...
    cartdiv.append(cartimg,cartname,cartdeleteimg,cartquantitydecreasebtn,cartquantity,cartquantityincreasebtn,totalpriceforoneproduct)

    document.querySelector("#cartpagemaindiv1").append(cartdiv);
})
}
